 ...
 */
    Vector3D DiffuseBSDF::f(const Vector3D wo, const Vector3D wi, double wavelength) {
        // TODO (Part 3.1):
 ...
 */
    Vector3D EmissionBSDF::f(const Vector3D wo, const Vector3D wi, double wavelength) {
        return Vector3D();
    }
